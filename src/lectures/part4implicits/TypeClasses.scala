...
import lectures.part4implicits.JSONSerialization.{JSONNumber, JSONObject, JSONString, JSONValue, Post}
...
//  }
  ...
  // or use implicit parameter also (UserSerializer is injected automatically)
  println(john.toHTML)
  ...
  /* Parts of typeClass patterns here:
